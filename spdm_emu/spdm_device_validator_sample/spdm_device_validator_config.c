...
common_test_case_config_t m_spdm_test_group_challenge_auth_configs[] = {
    ...
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A1B1C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A1B2C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A1B3C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A1B4C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A2B1C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A2B2C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A2B3C1, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_CHALLENGE_AUTH_SUCCESS_12_13_A2B4C1, COMMON_TEST_ACTION_RUN},
    {COMMON_TEST_ID_END, COMMON_TEST_ACTION_SKIP},
};
...
common_test_case_config_t m_spdm_test_group_measurements_configs[] = {
    ...
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SPDM_MEASUREMENT_BLOCK_10, COMMON_TEST_ACTION_RUN},
    ...
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SUCCESS_13, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SUCCESS_13_IN_DHE_SESSION, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SPDM_MEASUREMENT_BLOCK_11, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SPDM_MEASUREMENT_BLOCK_12, COMMON_TEST_ACTION_RUN},
    {SPDM_RESPONDER_TEST_CASE_MEASUREMENTS_SPDM_MEASUREMENT_BLOCK_13, COMMON_TEST_ACTION_RUN},
    {COMMON_TEST_ID_END, COMMON_TEST_ACTION_SKIP},
};
